...
class LaserSkeletonGrower
{
    public:
         ...
         */
        void setup(std::string master_element, std::string master_skeleton, std::string laser_sp, std::string laser_cam, bool is_laser_raw = false, std::string output_dir = "");
